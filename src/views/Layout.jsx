      ...
      <body>
        <header className="header">
          <nav className="navbar">
            ...
            <div className="navbar-container">
              <button className="navbar-button l-t-border-radius" id="home">
                Home
              </button>
              <button className="navbar-button r-t-border-radius" id="portfolio">
                Portfolio
              </button>
            </div>
            <div className="btn-log-reg">
              {user ? (
                <>
                  <a className="button margin-r-20" href="/auth/logout">
                    Logout
                  </a>
                ...
                <>
                  <a className="button margin-r-20" id="login" href="/auth/login">
                    LogIn
                  </a>

                  <a className="button" id="reg" href="/auth/registration">
                    Registration
                  </a>
                </>
              )}
        ...
        <footer className="footer">
          ...
          <div className="footer-btn-div">
            <a
              href="https://www.instagram.com/ant.alex.photo/"
              className="button footer-btn circle-btn first-circle "
            >
              <img className="svg" src="/img/instagram.svg" alt="instagram" />
            </a>
            <a
              href="https://www.facebook.com/alex.an.3363"
              className="button footer-btn circle-btn middle-circle "
            >
              <img className="svg" src="/img/facebook.svg" alt="facebook" />
            </a>
            <a
              href="https://500px.com/p/alantonoff"
              className="button footer-btn circle-btn last-circle "
            >
              <svg
                className="svg"
                id="logo_svg"
