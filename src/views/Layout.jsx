          ...
          <nav className="navbar">
            ...
            <div class="hamburger-menu">
              ...
              <ul class="menu__box">
                ...
                {user ? (
                  <li>
                    <a class="menu__item" href="/auth/logout">
                      Logout
                    </a>
                  </li>
                ) : (
                  <>
                    ...
                    <a id="reg" class="menu__item" href="/auth/registration">
                      Registration
                    </a>
                  </>
                )}
